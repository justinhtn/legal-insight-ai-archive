        ...
        {mode === 'chat' && (
          selectedClient ? (
            ...
            <div className="p-4 text-center text-gray-500">
              <p className="mb-2">Please select a client from the sidebar to start chatting</p>
              <p className="text-sm">Click on a client name in the DOCUMENTS section on the left</p>
            </div>
          )
        )}
